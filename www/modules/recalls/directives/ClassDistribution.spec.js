describe('recalls/directives/ClassDistribution.js', function () {
    ...
    beforeEach(inject(function (/**function*/ $compile, /**ng.$rootScope.Scope*/$rootScope, $injector) {
        ...
        directive = angular.element('<class-distribution></class-distribution>');
    ...
    it('should add custom class to element', function () {
        expect(directive.hasClass('class-distribution')).toBe(true);
