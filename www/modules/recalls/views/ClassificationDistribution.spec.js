/**
 * Unit tests for the view at route /recalls/classification-distribution
...
describe('URL Route: /recalls/classification-distribution', function () {
    ...
    it('should route to view if authenticated', function () {
        ...
        $scope.$apply();
        expect($ngView[0].querySelector('.classification-distribution')).not.toBe(null);
    });
    ...
    xit('should not route to view if not authenticated', function () {
        ...
        $location.path('/recalls/classification-distribution');
        $scope.$apply();
        expect($ngView[0].querySelector('.classification-distribution')).toBe(null);
    });
